...
var halfmoon = {
  ...
  // Get preferred mode
  getPreferredMode: function getPreferredMode() {
  ...
  deactivateAllDropdownToggles: function deactivateAllDropdownToggles() {
  ...
  toastAlert: function toastAlert(alertId, timeShown) {
  ...
  initStickyAlert: function initStickyAlert(param) {
